...
export default function Home() {
  return (
    <div className = ' flex flex-col  '>
        ...
        <div className=" w-full  h-80  bg-[url('https://t3.ftcdn.net/jpg/05/30/96/04/360_F_530960431_c8fPd3HansYvrSJ4fJxZqp9OhjQmYoll.webp')] bg-cover bg-center  " >
    ...
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20  -mt-52 bg-transparent">
        <div className="mb-4 bg-black">
            <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12 ">
                ...
                <h2
                    className="font-heading mb-4 font-bold tracking-tight  text-cyan-300  text-3xl sm:text-5xl">
                    Get in Touch
                </h2>
                    ...
                    <ul className="mb-6 md:mb-0">
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-medium leading-6 text-cyan-300">Our Address
                                </h3>
                        ...
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-medium leading-6  text-cyan-300">Contact
                                </h3>
                        ...
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-medium leading-6 text-cyan-300">Working
                                    hours</h3>
